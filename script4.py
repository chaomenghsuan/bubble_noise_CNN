...
f1 = [sorted([f for f in os.listdir(path[i]) if re.match(r'^ma4.+\.mat$', f)]) for i in range(len(path))]
...
labels1 = [csv[i].loc[csv[i]['Input.rightAnswer1'] == 'ma4'] for i in range(len(result_file))]
