...
f1 = [sorted([f for f in os.listdir(path[i]) if re.match(r'^ma2.+\.mat$', f)]) for i in range(len(path))]
...
labels1 = [csv[i].loc[csv[i]['Input.rightAnswer1'] == 'ma2'] for i in range(len(result_file))]
